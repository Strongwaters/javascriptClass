...
// // console.log(require(__dirname + '/example.js')); // 'foobar'
// console.log(Object.keys(require('fs')));
// console.log(__dirname); // this is the current directory name!
// console.log(process.cwd());

require('fs').writeFileSync(process.cwd() + '/tmp.txt', 'some text');
...
nowYouTry = function() {
    // read the books.json file from the filesystem.
    // after reading the file, only return the first 1,000 characters
    let result = require('fs').readFileSync(__dirname + '/books.json', 'UTF8');
    let breakDown = result.substr(0,1000);
